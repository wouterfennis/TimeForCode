...
{
    internal class DeleteDonorOrganizationHandler : IRequestHandler<DeleteDonorOrganizationCommand, Result>
    {
        ...
        public async Task<Result> Handle(DeleteDonorOrganizationCommand request, CancellationToken cancellationToken)
        {
            ...
            if (organization == null)
            {
                ...
                return Result.Failure($"Donor organization with id '{request.Id}' was not found.");
            }
